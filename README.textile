The famous ASIHTTPRequest with several features implemented by akisute.
* DEBUG_VERBOSE option to dump all response body string to your console
* ASIAPIRequest class to implement custom API request class much easier

Here's an original README:
